...
async def send_video_with_chat_id(client, sender, path, caption, duration, hi, wi, thumb_path, upm):
    ...
    try:
        await client.send_video(
            ...
            progress_args=(
                client,
                '❤️😍👍\n**__Unrestricting__: __[@gpsccrackfreev7_bot](https://t.me/gpsccrackfreev7_bot)__**\n',
                upm,
                time.time()
            )
        )
        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Download by ❤️😍👍\n\n__Unrestricted by **[@gpsccrackfreev7_bot](https://t.me/gpsccrackfreev7_bot)**__" if msg.caption else "__Download by ❤️😍👍\n\n__Unrestricted by **[@gpsccrackfreev7_bot](https://t.me/gpsccrackfreev7_bot)**__"
